...
class Serveces8 extends GetView<ServicesControllerImp> {
  const Serveces8({super.key});
    ...
    return Scaffold(
      body: Container(
        ...
        child: ListView(children: [
          ...
          GridView.builder(
              shrinkWrap: true,
              itemCount: gradtion.length,
              gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                  crossAxisCount: 2, childAspectRatio: 0.9),
              itemBuilder: (BuildContext context, index) {
                return InkWell(
                  onTap: () {
                    controller.goToPagePagedetails(index, "gradtion", args);
                  },
                  child: Container(
...
final List<Map<String, String>> gradtion = [
  {
    'name': 'Gradtion Book',
    'image': 'assets/images/bookgeadtion.png',
  },
    {
    'name': 'Demo',
