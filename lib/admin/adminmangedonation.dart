...
class MangeDonation extends StatefulWidget {
  @override
  State<MangeDonation> createState() => _MangeDonationState();
}

class _MangeDonationState extends State<MangeDonation> {
  @override
  void initState() {
    _retriveRequest();
    super.initState();
  ...
  Future<List> _retriveRequest() async {
    try {
      ...
      var response =
          await http.get(Uri.parse('${Share.Url}getDonation'), headers: {
 ...
 Get.offNamed(AppRoute.login);
        ...
        title: Text("Admin Mange Donation"),
        /* actions: [
          IconButton(
                  ...
                  if (snapshot.hasData) {
                        ...
                        children: [
                            Card(
                              ...
                              child: Row(
                                    ...
                                    children: [
                                              Text((index==0?"Total number of donors:":"").toString(),style: TextStyle(color: Colors.white,fontSize: 20),),
                    ...
                    Text("Student Name: "),
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Text("Type Donation: "),
                                      Text(snapshot.data?[index]['type_donation']),
                                    ],
                                  ),
                                    Divider(),
