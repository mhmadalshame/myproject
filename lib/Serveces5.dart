...
class Services5 extends GetView<ServicesControllerImp> {
  const Services5({super.key});
        ...
        child: ListView(children: [
          ...
          GridView.builder(
              ...
              itemBuilder: (BuildContext context, index) {
                return InkWell(
                  onTap: () {
                    controller.goToPagePagedetails(index,"sport",args);
                  },
                  child: Container(
...
final List<Map<String, String>> sport = [
  {
    'name': 'Chees',
    'image': 'assets/images/chees.png',
  },
  {
    'name': 'Football',
