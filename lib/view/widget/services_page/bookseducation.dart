// ignore_for_file: prefer_const_constructors_in_immutables, library_prefixes, avoid_print, prefer_const_constructors, unnecessary_string_interpolations
        ...
        body: isPermission
            ? ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  ...
                  return TileList(
                    fileUrl: "${Share.Url}getpdfpath1/${data['name']}",
                    title: data['name'],
                  );
                })
            : TextButton(
