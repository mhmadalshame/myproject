...
class Funny3 extends StatelessWidget {
  const Funny3({super.key});
                              ...
                              children: [
                                Expanded(
                                  child: Padding(
                                    padding: EdgeInsets.symmetric(vertical: 15),
                                    child: Text(
                                      "To participate in the competition, please submit your Programing recording or performance video via the email provided. Your performance must be original and bear your artistic mark.\nHurry to participate and let your voice dance and enchant the audience! Don't miss the opportunity to enjoy musical creativity and win valuable prizes.",
                                      style: TextStyle(
                                          fontSize: 14,
                                          fontWeight: FontWeight.w400),
                                    ),
                  ...
                  ElevatedButton.icon(
                      onPressed: () {
                        Get.offNamed(AppRoute.Sport1,
                            arguments: {'args': args, 'sporttype': 'Programing'});
                      },
                      icon: const Icon(
                        Icons.arrow_forward,
                        color: AppColor.black,
