...
// ignore_for_file: avoid_print, unnecessary_string_interpolations, prefer_const_constructors, prefer_const_constructors_in_immutables, library_prefixes
...
class Gradtion1 extends StatefulWidget {
  Gradtion1({super.key});

  @override
  State<Gradtion1> createState() => _Gradtion1State();
}

class _Gradtion1State extends State<Gradtion1> {
  ...
  Future<void> fetchNewsData() async {
    String url = "${Share.Url}getpdfgradtin";
        ...
        body: isPermission
            ? ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  ...
                  return TileList(
                    fileUrl: "${Share.Url}getpdfpathgradtion/${data['name']}",
                    title: data['name'],
                  );
                })
            : TextButton(
