...
class Advertisements2 extends StatefulWidget {
  @override
  _Advertisements2State createState() => _Advertisements2State();
}

class _Advertisements2State extends State<Advertisements2> {
  List<dynamic> newsData = [];

  Future<void> fetchNewsData() async {
    String url = "${Share.Url}getNewsUniversity";
    final response =
